      ...
      <main className="flex-1 flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-xl">
          ...
          <div className="flex justify-center mb-6">
            <div className="rounded-2xl p-4" style={{ backgroundColor: '#e8f5f3' }}>
              <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#0f7c6e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
